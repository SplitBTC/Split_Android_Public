...
Android changes should be reviewed for:

- encrypted preferences or Android Keystore failures
- seed phrase exposure through UI, logs, screenshots, clipboard, backups, intents, or exported components
- wallet-auth signature regressions
- QR and intent parsing mistakes
- Firebase/FCM token handling mistakes
- cleartext and network security configuration regressions
- sensitive data leakage through crash logs, debug output, or notifications
- signing, package ID, manifest, or exported component mistakes
